namespace Store.Contracts.V1
{
    public static class ApiRoutes
    {
        ...
        {
            public const string AddToCart = Base + "cart/add";
            public const string CommitCart = Base + "cart/commit";
            public const string DeleteCart = Base + "cart/delete";
            public const string GetCartItems = Base + "cart/items";
        }
    }
}